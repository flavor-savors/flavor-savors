    ...
    return (
      <div className='day'>
        ...
        <div className='meal-names'>
          ...
          <button onClick={() => this.props.handleChange(this.props.b)}>
            Breakfast
          </button>
        </div>
        <div className='meal-names'>
          ...
          <button onClick={() => this.props.handleChange(this.props.l)}>
            Lunch
          </button>
        </div>
        <div className='meal-names'>
          ...
          <button onClick={() => this.props.handleChange(this.props.d)}>
            Dinner
          </button>
        </div>
        <div className='meal-names'>
          ...
          <button onClick={() => this.props.handleChange(this.props.s)}>
            Snack
          </button>
        </div>
      </div>
